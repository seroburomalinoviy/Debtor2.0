...
Задолженность  покупками🛍 - отправит тебе список всех неотмеченных покупок с подробностями о каждой покупке, ты сможешь 
отметить покупки по одной. Эта выписка также позволяет зачесть долги.\n
Задолженность участнику👤 - предоставит список всех участников комнаты и долги каждому из 
них, а также возможность отметить все задолженность одному участнику.\n
